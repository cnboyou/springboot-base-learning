...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //Author设置作者
        globalConfig.setAuthor("Mr_Wang");
        //是否覆盖文件
        ...
        dataSourceConfig.setUrl("jdbc:mysql://39.108.251.115:3306/mybatisdb?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
        dataSourceConfig.setDriverName("com.mysql.jdbc.Driver");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("wyh19950212");
